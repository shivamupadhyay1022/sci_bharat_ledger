...
const IndividualSales = () => {
  ...
  return (
    <div className="p-4">
      <div className="mb-4">
        <h1 className="text-xl font-semibold">{t("individual_sales_management")}</h1>
        <p className="text-gray-500 dark:text-gray-400">{t("individual_sales_description")}</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow p-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
          <div className="relative w-full md:max-w-xl">
            <input
              type="text"
              placeholder={t("search_individual_sales")}
              value={searchQuery}
